...
public class TestAbsShape {
    public static void main(String[] args) {
        Shape shape1 = new Circle(5.5, "red", false);
        System.out.println(shape1);
        System.out.println(shape1.getArea());
        System.out.println(shape1.getPrimeter());
        System.out.println(shape1.getColor());
        System.out.println(shape1.isFilled());
        // Không thể gọi getRadius do getRadius bị che đi khó khai báo Shape
        ...
        if(shape1 instanceof Circle) {
            ...
            System.out.println(circle1.getPrimeter());
        ...
        System.out.println(shape3.getPrimeter());
